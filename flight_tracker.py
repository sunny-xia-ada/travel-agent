...
def format_status(route: str, carrier: str, price: float, trend: str) -> str:
    ...
    return f"Antigravity Status: {route} | {carrier} | {price_display} | [Trend: {trend}]"
...
<head>
    ...
    <title>Antigravity Flight Intelligence</title>
...
<body>
    <div class="container">
        ...
        <footer>
            Generated by Antigravity Travel Agent • Data synced with Google Flights
        </footer>
    </div>
</body>
</html>
